    ...
    <footer className="bg-(--navy) text-[#FAF9F6]">
      <div className="max-w-5xl mx-auto px-5 py-8 text-sm">
        ...
        <div className="flex flex-col gap-6 text-center md:text-left md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-10 md:gap-y-2 md:items-start">
          {/* Always first */}
          <p className="order-1 text-sm font-semibold tracking-[0.18em] uppercase md:order-0 md:col-start-1 md:row-start-1">
            Jerusalem Heritage Realty
          </p>

          {/* Contact should be second on mobile, right on desktop */}
          <div className="order-2 text-sm text-gray-400 md:order-0 md:col-start-2 md:row-start-1 md:row-span-2 md:text-right">
            <p>
              US:{" "}
              <a
          ...
          <p className="order-3 text-sm text-gray-400 md:order-0 md:col-start-1 md:row-start-2">
