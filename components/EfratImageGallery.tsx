...
export default function EfratImageGallery({ images }: EfratImageGalleryProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
      <div className="relative aspect-[16/9] overflow-hidden rounded-lg border border-white/15 bg-white/5">
        <Image
          src={selectedImage}
      ...
      <div className="grid grid-cols-3 gap-3 lg:grid-cols-2 lg:content-start">
        {images.map((src, index) => (
          <button
            ...
            className="group relative aspect-[16/9] overflow-hidden rounded-lg border border-white/15 bg-white/5 ring-offset-2 ring-offset-[#071b34] transition hover:border-[#d8b46d] aria-pressed:border-[#d8b46d] aria-pressed:ring-2 aria-pressed:ring-[#d8b46d]"
          >
            <Image
              src={src}
              alt=""
